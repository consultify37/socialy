...
const Terms = () => {
  return (
<div className='pt-36 md:pt-48 px-6 sm:px-7 md:px-[80px] xl:px-[140px] 2xl:px-[276px]'>
<ul className='mt-4'>
<h1 className='text-2xl'><strong>Termeni și condiții</strong></h1><br/>
...
<p className='mt-4'>Continut&nbsp;&ndash; reprezinta:</p>
<ul className='mt-4'>
    ...
    <li>continutul oricarui mesaj trimis Cumparatorilor de catre Prestator prin mijloace electronice si/sau orice alt mijloc de comunicare disponibil;</li>
    <li>orice informatie comunicata Cumparatorului prin orice mijloc de catre un angajat/colaborator al Prestatorului, conform informatiilor de contactare, specificate sau nu de catre acesta;</li>
    <li>informatii legate de Serviciile si/sau tarifele practicate de Prestator intr-o anumita perioada;</li>
    <li>informatii legate de Serviciile si/sau tarifele practicate de catre un tert cu care Prestatorul are incheiate contracte de parteneriat, intr-o anumita perioada;</li>
    <li>date referitoare la Prestator, sau alte date privilegiate ale acestuia.</li>
</ul>
<div className='h-1'></div>
<p className='mt-4'>Review&nbsp;&ndash; o evaluare scrisa de catre detinatorul sau beneficiarul unui Serviciu, evaluare redactata pe baza experientei personale si capacitatii acestuia de a realiza comentarii calitative și de a spune daca Serviciul respecta sau nu standardele de calitate solicitate;</p>
<p className='mt-4'>Rating&nbsp;&ndash; modalitate de exprimare a gradului de satisfactie a unui Utilizator/Client/Cumparator fata de un produs. Rating-ul se exprima sub forma de stele, fiecare Serviciu putand primi un punctaj de la o stea, la cinci stele. Acest grad de satisfactie va fi asociat intotdeauna review-ului scris de Utilizator/Client/Cumparator asupra unui Serviciu.</p>
<p className='mt-4'>Comentariu&nbsp;&ndash; apreciere sau observatie cu scop critic, pe marginea unui Review sau a unui alt comentariu.</p>
<p className='mt-4'>Intrebare&nbsp;&ndash; formula de adresare catre alti Utilizatori/Clienti/Cumparatori cu scopul de a obtine informatii despre Serviciile din pagina respectiva.</p>
...
<div className='h-1'></div>
<p className='mt-4'>2.1. Prin inregistrarea unei Comenzi pe Site, Cumparatorul este de acord cu forma de comunicare (telefonic, in scris sau e-mail) prin care Prestatorul isi deruleaza operatiunile comerciale.</p>
<p className='mt-4'>2.2. Contractul se considera incheiat intre Prestator si Cumparator/Client in momentul primirii de catre Prestator, prin intermediul postei electronice sau a unui serviciu de curierat a contractului semnat de catre Client.</p>
<p className='mt-4'>2.3. Documentul si informatiile puse la dispozitie de catre Prestator pe Site vor sta la baza Contractului.</p>
<ul className='mt-4'>
    <li><strong>3. POLITICA DE VANZARE ONLINE</strong></li>
</ul>
<div className='h-1'></div>
...
<ul className='mt-4'>
    <li><strong>4. DREPTUL DE PROPRIETATE INTELECTUALA SI INDUSTRIALA</strong></li>
</ul>
<div className='h-1'></div>
...
<p className='mt-4'>5.7. In cazul in care Clientul/Cumparatorul solicita retragerea din Contract in cadrul termenului legal de retragere din contract, trebuie sa returneze si eventualele cadouri care au insotit produsul/serviciul respectiv. In cazul in care Comanda este achitata, Prestatorul va rambursa suma in maxim 14 (paisprezece) zile de la data informarii Prestatorului de catre Cumparator asupra deciziei sale de retragere din Contract. Suma va fi returnata dupa cum urmeaza:</p>
<p className='mt-4'>5.7.1. pentru Comenzile achitate cu card online -&gt;prin restituire in contul din care a fost efectuata plata&nbsp;sau prin generarea unui voucher cu valoarea produsului returnat;</p>
<p className='mt-4'>5.7.2. pentru Comenzile achitate cu Op/ramburs/iTransfer/ Card bancar-&gt; prin virament bancar&nbsp;sau prin generarea unui voucher cu valoarea produsului returnat;</p>
<p className='mt-4'>5.7.3. pentru Comenzile achitate cu numerar sau card bancar la sediu -&gt; prin restituire numerar, prin restituirea contravalorii serviciului in contul bancar transmis de client sau prin generarea unui voucher cu valoarea produsului returnat.</p>
<p className='mt-4'>5.8. Daca Serviciul a fost prestat la solicitarea expresa a Clientului, contravaloarea acestuia nu va mai fi returnata, conform dispozitiilor. Art. 16 din OUG nr. 34 / 2014.</p>
<p className='mt-4'>5.9. In cazul in care un Serviciu comandat de catre Cumparator, nu poate fi livrat de catre Prestator, acesta din urma va informa Clientul/Cumparatorul asupra acestui fapt si va returna in contul Cumparatorului contravaloarea Bunului si/sau Serviciului, in termen de maxim 7 (sapte) zile de la data la care Prestatorul a luat la cunostinta acest fapt sau de la data la care Cumparatorul si-a exprimat in mod expres intentia de reziliere a Contractului.</p>
<ul className='mt-4'>
...
<ul className='mt-4'>
    <li><strong>7. COMUNICARI COMERCIALE</strong></li>
</ul>
<div className='h-1'></div>
<p className='mt-4'>7.1. Cumparatorul/Utilizatorul/Clientul isi poate modifica in orice moment optiunea cu privire la acordul dat Prestatorului pentru Comunicarile Comerciale continand informatii generale si tematice inclusiv informatii cu privire la oferte sau promotii, dupa cum urmeaza:</p>
<p className='mt-4'>7.1.2. prin modificarea setarilor din Cont ;</p>
<p className='mt-4'>7.1.3. prin accesarea link-ului de dezabonare afisat in Comunicarile Comerciale primite de la Prestator; sau</p>
<p className='mt-4'>7.1.4. prin contactarea Prestatorului.</p>
<ul className='mt-4'>
...
<ul className='mt-4'>
    <li><strong>9. PRESTAREA SERVICIILOR ACHIZITIONATE PE SITE</strong></li>
</ul>
<div className='h-1'></div>
<p className='mt-4'>9.1. Prestatorul va presta toate serviciile la care s-a agajat in termenele si in conditiile din contractul scris incheiat cu fiecare Client / Cumparator.</p>
<ul className='mt-4'>
    <li><strong>10. RASPUNDERE</strong></li>
</ul>
<div className='h-1'></div>
<p className='mt-4'>10.1. Prestatorul nu poate fi responsabil pentru daune de orice fel pe care Cumparatorul sau oricare terta parte o poate suferi ca rezultat al indeplinirii de catre Prestator a oricarei din obligatiile sale conform Comenzii. Raspunderea partilor este reglementata de contractul scris incheiat anterior inceperii presarii serviciilor.</p>
<p className='mt-4'>10.2. Prin crearea si utilizarea Contului, Utilizatorul/ Cumparatorul isi asuma raspunderea pentru mentinerea confidentialitatii datelor de Cont (user si parola) si pentru gestionarea accesarii Contului, si, in masura permisa de legislatia in vigoare, este responsabil de activitatea derulata prin intermediul Contului sau.</p>
<p className='mt-4'>10.3. Prin crearea Contului si/sau utilizarea Continutului si/sau plasarea Comenzilor, Clientul / Utilizatorul/ Cumparatorul accepta in mod expres si fara echivoc Termenii si Conditiile Site-ului in ultima versiune actualizata care este comunicata in cadrul Site-ului, existenta la data crearii Contului si/sau utilizarii continutului si/sau la data plasarii Comenzii.</p>
<p className='mt-4'>10.4. Prestatorul isi rezervă dreptul de a actualiza și modifica periodic Termenii si Conditiile Site-ului pentru a reflecta orice modificări ale modului si conditiilor de functionare a Site-ului sau orice modificări ale cerințelor legale. Documentul este opozabili Clientilor / Utilizatorilor/ Cumparatorilor de la momentul afisarii in Site. &Icirc;n cazul oricărei astfel de modificări, vom afișa pe Site versiunea modificată a Documentului, motiv pentru care va rugam sa verificati periodic continutul acestui Document.</p>
<ul className='mt-4'>
...
<div className='h-1'></div>
<p className='mt-4'>12.1. Vezi Politica de cookies, care face parte din prezentul Document.</p>
<ul className='mt-4'>
    <li><strong>13. FORTA MAJORA</strong></li>
</ul>
<div className='h-1'></div>
<p className='mt-4'>13.1. Nici una din parti nu va fi raspunzatoare pentru neexecutarea obligatiilor sale contractuale, daca o astfel de neexecutare la termen si/sau in mod corespunzator, total sau partial este datorata unui eveniment de forta majora. Forta majora este evenimentul imprevizibil, in afara controlului partilor si care nu poate fi evitat.</p>
<p className='mt-4'>13.2. Daca in termen de 15 (cincisprezece) zile de la data producerii lui, respectivul eveniment nu inceteaza fiecare parte va avea dreptul sa notifice celeilalte parti incetarea de plin drept a contractului fara ca vreuna dintre ele sa poata pretinde celeilalte alte daune-interese.</p>
<ul className='mt-4'>
    <li><strong>14. LEGEA APLICABILA &ndash; JURISDICTIA</strong></li>
</ul>
<div className='h-1'></div>
<p className='mt-4'>14.1. Prezentul contract este supus legii romane. Eventualele litigii aparute intre Prestator si Utilizatori / Cumparatori se vor rezolva pe cale amiabila sau, in cazul in care aceasta nu va fi posibila, litigiile vor fi solutionate de instantele judecatoresti romane competente din Municipiul Bucuresti.</p>
<ul className='mt-4'>
