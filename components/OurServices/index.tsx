        ...
        <section className="w-full flex flex-col items-center px-7 md:px-[80px] xl:px-[180px] 2xl:px-[276px]">
            ...
            <div className="flex flex-col lg:grid lg:gap-5 lg:grid-cols-2 mt-12 md:mt-24">
                <Link
                    href='/Programe'
                >
                    <div className="group/card-1 flex relative flex-row bg-[#F6EFFF] p-6 pb-10   rounded-3xl mb-8 hover:shadow-2xl cursor-pointer">
                ...
                <Link
                    href='/shop'
                >
                    <div className="group/card-2 flex relative flex-row bg-[#F6EFFF] p-6 pb-10   rounded-3xl mb-8 hover:shadow-2xl cursor-pointer">
                        <div className="w-[-webkit-fill-available] max-w-[fit-content] flex items-center rounded-xl bg-[#A634FF] p-3 lg:p-4 h-[max-content] jutify-center mr-2">
                            <Image
                ...
                >
                    <div className="group/card-3 flex relative flex-row bg-[#F6EFFF] p-6 pb-10 rounded-3xl mb-8 hover:shadow-2xl cursor-pointer">
                        <div className="w-[-webkit-fill-available] max-w-[fit-content] flex items-center rounded-xl bg-[#A634FF] p-3 lg:p-4 h-[max-content] jutify-center mr-2">
                            <Image
