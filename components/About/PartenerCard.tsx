...
const PartenerCard = ({ numberOfStars, experienceRating, feedBackRating, humanResourcesRating, transparencyRating, cui, name, nr }: Props) => {
  return (
    <div className="w-full bg-[#FBF6FF] rounded-[22px] border-[1px] border-[#EFE0FF] mx-8 md:px-16 py-8 px-4 flex flex-col">
      ...
      <div className="flex flex-row mt-[10px] items-center">
        <div className="w-[70%] md:w-[75%] lg:w-[80%] xl:w-[85%] border-primary border-2 rounded-md mr-4">
          <div className="bg-primary rounded-e-md p-1 py-[2px]" style={{width: (transparencyRating/2).toString()+'%'}}>
            <p className="text-onSecondary text-[14px] font-semibold">Transparență</p>
          </div>
        </div>
      ...
      <div className="flex flex-row mt-[10px] items-center">
        <div className="w-[70%] md:w-[75%] lg:w-[80%] xl:w-[85%] border-[#7000FF] border-2 rounded-md mr-4">
          <div className="bg-[#7000FF] rounded-e-md p-1 py-[2px]" style={{width: (feedBackRating/2).toString()+'%'}}>
      ...
      <div className="flex flex-row mt-[10px] items-center">
        <div className="w-[70%] md:w-[75%] lg:w-[80%] xl:w-[85%] border-[#5400BE] border-2 rounded-md mr-4">
          <div className="bg-[#5400BE] rounded-e-md p-1 py-[2px]" style={{width: (humanResourcesRating/2).toString()+'%'}}>
