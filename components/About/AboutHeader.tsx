...
const AboutHeader = () => {
    return(
        <section id='about-header' className='relative bg-[#00103C] w-full pt-32 pb-14 flex flex-col items-center justify-center overflow-visible' style={{marginBottom: `128px`}}>
