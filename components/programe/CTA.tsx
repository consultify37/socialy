  ...
  return(
      <section className="w-full mt-12 md:mt-24">
          <div className="w-full flex relative flex-col h-[300px] lg:h-[400px] justify-center items-center px-6 py-6 lg:py-12 lg:px-12 bg-[#F7EDFF] rounded-3xl">
              ...
              <Link className="py-4 bg-[#8717F8] text-center text-white rounded-[28.5px] font-medium px-10 text-sm md:text-[16px] transition-all hover:scale-[1.05]" href={linkHref}>{linkText}</Link>
          </div>
      </section>
  )
}