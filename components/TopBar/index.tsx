        ...
        <div className="fixed w-full z-[999] bg-[#8717F8]">
            <div className="flex flex-row items-center justify-between mx-4 py-2 md:mx-[80px] xl:mx-[140px] 2xl:mx-[276px]">
                ...
                <div className="flex flex-row justify-center items-center">
                    ...
                    <Link href='https://instagram.com' target="_blank" className="flex flex-row items-center text-white hover:scale-105 transition-all">
                        <Image src='/images/TopBar/socials/insta-white.svg' width={20} height={20} alt="phone" className="mr-2 w-[14px] md:w-[20px]"/>
                    </Link>
                    <Link href='https://instagram.com' target="_blank" className="flex flex-row items-center text-white ml-2 hover:scale-105 transition-all">
