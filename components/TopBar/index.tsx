        ...
        <div className="fixed w-full z-[999] bg-[#8717F8]">
            <div className="flex flex-row items-center justify-between mx-4 py-2 md:mx-[80px] xl:mx-[140px] 2xl:mx-[276px]">
                ...
                <div className="flex flex-row justify-center items-center">
                    ...
                    <Link href='https://www.tiktok.com/@consultifyro?_t=8hf9YsK4ZsX&_r=1' target="_blank" className="flex flex-row items-center text-white ml-2 hover:scale-105 transition-all ">
