          ...
          <div className={"rounded-full flex flex-row justify-between items-center px-8 lg:px-[60px] py-2 md:py-4 duration-300 transition-all " + (!pathname?.includes('/blog-post') || scrollPosition != 0 ? "bg-[#260056]" : "bg-transparent")}>
            <Link href="/" className="flex items-center justify-center z-[99]">
              <Image
                ...
                width={120}
                height={38}
                className="align-middle w-[120px] md:w-[160px]"
                alt="Consultify logo"
              />
            </Link>
            ...
            >
              ...
              >
                <Link href="/" className="font-semibold text-white text-[16px]">
                  acasă
                </Link>
              </li>
              <li
              ...
              >
                <Link href="/despre" className="font-semibold text-white text-[16px]">
                  despre
                </Link>
              </li>
              <li
              ...
              >
                <Link href="/testimoniale" className="font-semibold text-white text-[16px]">
                  testimoniale
                </Link>
              </li>
              {/* <li
              ...
              >
                <Link href="/blog" className="font-semibold text-white text-[16px]">
                  blog
                </Link>
              </li> */}
              <li
              ...
              >
                <Link href="/servicii" className="font-semibold text-white text-[16px]">
                  servicii
                </Link>
              </li>
              {/* <li
              ...
              >
                <Link href="/shop" className="font-semibold text-white text-[16px]">
                  shop
                </Link>
              </li> */}
              <li
