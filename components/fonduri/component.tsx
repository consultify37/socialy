...
export default function FonduriComponent({ program }: Props) {
    return(
        <div 
            className="rounded-[35px] mb-8 mx-2 md:mx-[30px] relative w-full h-auto lg:h-[400px] flex flex-col-reverse md:flex-row justify-between px-4 md:px-20 py-2 bg-cover bg-no-repeat align-center"
        >   
