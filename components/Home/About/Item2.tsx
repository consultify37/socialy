...
const Item2About = () => {
    return(
        <div className='w-full mt-16 mx-auto px-7 md:px-[80px] gap-[6rem] xl:px-[140px] 2xl:px-[276px] flex gap-y-20 gap-5 justify-between flex-col-reverse md:flex-row flex-wrap z-[2]'>
