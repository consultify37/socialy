        ...
        <div className='w-full mt-16 mx-auto px-7 md:px-[80px] xl:px-[140px] 2xl:px-[276px] flex gap-y-20 gap-5 justify-between flex-col-reverse md:flex-row flex-wrap z-[2]'>
                ...
                <div className='w-full md:w-[48%]'>
                    ...
                    <div className='flex gap-4 mt-6'>
                        <Link href='' className='py-4 bg-[#8717F8] text-white rounded-[28.5px] font-medium px-14 text-xs md:text-[16px]'>shop</Link>
                        <Link href='' className='py-4 bg-transparent text-white rounded-[28.5px] border-2 border-[#BA63FF] font-medium text-xs md:text-[16px] px-14'>testimoniale</Link>
                    </div>
                </div>
            </div>
    )
