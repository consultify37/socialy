    ...
    return(
        <div className='w-full mt-16 mx-auto px-7 md:px-[80px] xl:px-[140px] 2xl:px-[276px] flex gap-y-20 gap-5 justify-between flex-col-reverse md:flex-row z-[2]'>
            ...
            <div className='w-full md:w-[48%]'>
                ...
                <p className='text-white font-base text-[16px] mt-5 max-w-[650px]'>
                ...
                <div className='flex gap-6 mt-6'>
                    <Link href='/shop' className='py-3 bg-[#BA63FF] text-[#fff] flex items-center rounded-[28.5px] px-12 transition-all hover:scale-[1.05]'>Shop</Link>
                    <Link href='/servicii' className='py-3 bg-transparent text-white flex items-center rounded-[28.5px] border-2 border-[#8717F8] px-12 transition-all hover:scale-[1.05]'>Servicii</Link>
                </div>
            </div>
        </div>
    )
