        ...
        <footer className='w-full mt-[6.25rem]'>
            <div className='flex flex-wrap flex-col justify-between md:flex-row gap-10 px-7 md:px-[80px] xl:px-[140px] 2xl:px-[276px]'>
                <div className='flex flex-col gap-2 w-full md:w-[35%]'>
                    ...
                    <p className='text-[#00103C] text-[14px] md:text-[16px]'>
                        Mauris tristique pulvinar massa, ut hendrerit enim pretium nec. Fusce sed dolor est. 
                    </p>
                </div>
                <div className='flex flex-col gap-1'>
                    <h3 className='font-bold text-[#00103C] text-[24px]'>Navigație</h3>
                ...
                <div className='flex flex-col gap-1'>
                    <h3 className='font-bold text-[#00103C] text-[24px]'>Informații</h3>
                    <ul className='list-none flex flex-col gap-1'>
                        <li>
                        ...
                        <li>
                            <p className='font-medium text-[#0F52FF] text-[16px]'>SC. INSPIRELY S.R.L.</p>
                        </li>
                        <li>
            ...
            <div className='w-full mt-5 text-center md:px-[80px] xl:px-[140px] 2xl:px-[276px]'>
                <p className='text-[#0F52FF] text-[16px] font-medium  border-t-[3px] border-[#00103C] py-4 px-16 md:px-0'>
                    Copyright 2022 Inspirely | Made with love by &nbsp;
