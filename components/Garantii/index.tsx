...
export default function Garantii(){
    return(
        <section className="w-full flex flex-col items-center mt-20 px-7 md:px-[80px] xl:px-[140px] 2xl:px-[276px]">
            <h2 className="text-xl lg:text-3xl text-[#8717F8] self-start lg:self-center font-bold mb-12">Iata ce garantii iti ofera Consultify</h2>
                    ...
                    <div className="box mb-10 lg:mb-0">
                        <div className="card">
                            <div className="front flex flex-col justify-center px-6 bg-[#260056] border-8 border-[#7000FF]">
                                <h4 className="text-white text-lg lg:text-2xl font-bold">Descopera garantia scrierii proectului</h4>
                                {/* <p className="text-lg text-[#EDD7FF]">Apasa pentru a afla detalii</p> */}
                            </div>
                            <div className="back px-6 bg-[#260056] border-8 border-[#7000FF]">
                                <h4 className="text-white text-lg lg:text-2xl font-bold">Back of Card</h4>
                                <p className="text-lg text-[#EDD7FF]">Additional info on the back of the card</p>
                            </div>
                        </div>
                    </div>
                    <div className="box mb-10 lg:mb-0">
